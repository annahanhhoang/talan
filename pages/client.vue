    ...
    <v-container class="mt-6">
      <v-row align="center">
        ...
        <v-col cols="6">
          ...
          Advisor to understand the business objective. Our HR Advisor will create a talent pipeline
          utilizing our extensive network of professionals ensuring each placement results in an
          ideal match.
        </v-col>
      </v-row>
    </v-container>
